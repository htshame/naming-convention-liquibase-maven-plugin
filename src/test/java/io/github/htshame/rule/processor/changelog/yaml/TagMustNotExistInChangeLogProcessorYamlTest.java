package io.github.htshame.rule.processor.changelog.yaml;
...
public class TagMustNotExistInChangeLogProcessorYamlTest extends ChangeLogRuleProcessorTestUtil {
     ...
     * Default constructor.
     */
    public TagMustNotExistInChangeLogProcessorYamlTest() {
    ...
    public void testValidateChangeSetFailure() throws ParserConfigurationException,
        ...
        List<String> expectedErrorMessages = Arrays.asList(
                "Key <includeAll> must not exist in change log",
                "Key <includeAll> must not exist in change log"
        );
