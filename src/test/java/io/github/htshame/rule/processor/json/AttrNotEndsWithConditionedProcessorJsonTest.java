...
public class AttrNotEndsWithConditionedProcessorJsonTest extends ChangeSetRuleProcessorTestUtil {
     ...
     * Default constructor.
     */
    public AttrNotEndsWithConditionedProcessorJsonTest() {
    ...
    public void testValidateChangeSetFailure() throws ParserConfigurationException,
        ...
        List<String> expectedErrorMessages = Arrays.asList(
                prepareTestErrorMessage(
                        "changelog_02_3",
                        "test",
                        List.of("Object [createIndex] with unique=\"true\" must not have property [indexName] "
                                + "ending with [_unique], "
                                + "but found: [user_metadata_external_user_id_unique_idx_unique]")),
                prepareTestErrorMessage(
                        "changelog_02_4",
                        "test",
                        List.of("Object [createIndex] with unique=\"true\" must not have property [indexName] "
