...
public class AttrStartsWithConditionedProcessorXmlTest extends ChangeSetRuleProcessorTestUtil {
     ...
     * Default constructor.
     */
    public AttrStartsWithConditionedProcessorXmlTest() {
    ...
    public void testValidateChangeSetFailure() throws ParserConfigurationException,
        ...
        List<String> expectedErrorMessages = Arrays.asList(
                prepareTestErrorMessage(
                        "changelog_02_3",
                        "test",
                        List.of("Tag <createIndex> with unique=\"true\" must have [indexName] starting "
