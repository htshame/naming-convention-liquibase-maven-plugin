...
public class AttrMustExistInTagProcessorJsonTest extends ChangeSetRuleProcessorTestUtil {
     ...
     * Default constructor.
     */
    public AttrMustExistInTagProcessorJsonTest() {
    ...
    public void testValidateChangeSetFailure() throws ParserConfigurationException,
        ...
        List<String> expectedErrorMessages = Arrays.asList(
                prepareTestErrorMessage(
                        "changelog_01_1",
                        "test",
                        List.of("Object <createTable>. Property [remarks] is missing or empty")),
                prepareTestErrorMessage(
                        "changelog_01_2",
                        "test",
                        List.of("Object <createTable>. Property [remarks] is missing or empty")));
