...
public class NoUnderscoresInAttributesProcessorTest extends RuleProcessorTest {
    ...
    private static final String RULE_URL =
            "src/test/resources/io/github/htshame/rule/processor/no-underscores-in-attributes-rule.xml";
    ...
    public void testValidateFailure() throws ParserConfigurationException, IOException, SAXException {
        ...
        // act
        try {
            NoUnderscoresInAttributesProcessor.fromXml(ruleElement).validate(document);
