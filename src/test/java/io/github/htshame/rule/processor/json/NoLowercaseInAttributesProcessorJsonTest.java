...
public class NoLowercaseInAttributesProcessorJsonTest extends RuleProcessorTestUtil {
    ...
    private static final String CHANGELOG_FAILURE_FILE = "no-lowercase-in-attributes-failure.json";
    private static final String CHANGELOG_SUCCESS_FILE = "no-lowercase-in-attributes-success.json";
