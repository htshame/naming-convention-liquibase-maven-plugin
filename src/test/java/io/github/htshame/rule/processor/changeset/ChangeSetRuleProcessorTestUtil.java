...
public class ChangeSetRuleProcessorTestUtil {
    ...
    private static final String BASE_PATH = "src/test/resources/io/github/htshame/rule/processor/changeset/";
    ...
    protected List<ChangeLogElement> parseChangeSetFile(final String filePath,
        ...
        return ValidatorTestUtil.getParser(format).parseChangeSets(changeLogFile);
    }
