...
public class AttrStartsWithConditionedProcessorJsonTest extends ChangeSetRuleProcessorTestUtil {
     ...
     * Default constructor.
     */
    public AttrStartsWithConditionedProcessorJsonTest() {
    ...
    public void testGetType() throws ParserConfigurationException, IOException, SAXException {
        ...
        // act
        RuleTypeEnum actual = AttrStartsWithConditionedProcessor.instantiate(ruleElement).getType();
    ...
    public void testValidateChangeSetFailure() throws ParserConfigurationException,
        ...
        List<String> expectedErrorMessages = Arrays.asList(
                prepareTestErrorMessage(
                        "changelog_02_3",
                        "test",
                        List.of("Object [createIndex] with unique=\"true\" must have property [indexName] starting"
                                + " with [idx_unique_], but found: [user_metadata_external_user_id_unique_idx]")),
                prepareTestErrorMessage(
                        "changelog_02_4",
                        "test",
                        List.of("Object [createIndex] with unique=\"true\" must have property [indexName] starting"
