...
public class AttrEndsWithProcessorJsonTest extends RuleProcessorTestUtil {
    ...
    private static final String ATTR_ENDS_WITH_FAILURE = "attr-ends-with-failure.json";
    private static final String ATTR_ENDS_WITH_SUCCESS = "attr-ends-with-success.json";

    /**
     * Default constructor.
     */
    public AttrEndsWithProcessorJsonTest() {
    ...
    public void testValidateFailure() throws ParserConfigurationException,
        ...
        List<ChangeSetElement> changeSetElements = parseChangeSetFile(
                BASE_FILE_PATH + ATTR_ENDS_WITH_FAILURE,
        ...
        List<String> expectedErrorMessages = Arrays.asList(
                prepareTestErrorMessage(
                        "changelog_02_1",
                        "test",
                        List.of("Object [addForeignKeyConstraint] must have property [constraintName] "
                                + "ending with [_fk], but found: "
                                + "[fk_user_activation_user_profile_id_user_profile_id]")),
                prepareTestErrorMessage(
                        "changelog_02_2",
                        "test",
                        List.of("Object [addForeignKeyConstraint] must have property [constraintName] "
                                + "ending with [_fk], but found: "
                                + "[user_activation_user_profile_id_user_profile_id_FK]")));
    ...
    public void testValidateSuccess() throws ParserConfigurationException,
        ...
        // arrange
        List<ChangeSetElement> changeSetElements = parseChangeSetFile(
                BASE_FILE_PATH + ATTR_ENDS_WITH_SUCCESS,
                ChangeLogFormatEnum.JSON);
