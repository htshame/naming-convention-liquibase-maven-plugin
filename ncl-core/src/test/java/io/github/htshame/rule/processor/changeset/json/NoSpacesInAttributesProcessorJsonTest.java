...
public class NoSpacesInAttributesProcessorJsonTest extends ChangeSetRuleProcessorTestUtil {

    private static final RuleEnum RULE_ENUM = RuleEnum.NO_SPACES_IN_ATTRIBUTES;
    private static final ChangeLogFormatEnum CHANGELOG_FORMAT = ChangeLogFormatEnum.JSON;

    /**
     * Default constructor.
     */
    public NoSpacesInAttributesProcessorJsonTest() {
    ...
    public void testGetName() throws ParserConfigurationException, IOException, SAXException {
        ...
        // act
        RuleEnum actual = NoSpacesInAttributesProcessor.instantiate(ruleElement).getName();
