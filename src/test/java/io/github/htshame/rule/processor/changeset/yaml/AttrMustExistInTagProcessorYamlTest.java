...
public class AttrMustExistInTagProcessorYamlTest extends ChangeSetRuleProcessorTestUtil {
     ...
     * Default constructor.
     */
    public AttrMustExistInTagProcessorYamlTest() {
    ...
    public void testValidateChangeSetFailure() throws ParserConfigurationException,
        ...
        List<String> expectedErrorMessages = Arrays.asList(
                prepareTestErrorMessage(
                        "changelog_02_3",
                        "test",
                        List.of("Key <createTable>. Property [remarks] is missing or empty")),
                prepareTestErrorMessage(
                        "changelog_02_4",
                        "test",
                        List.of("Key <createTable>. Property [remarks] is missing or empty")));
