...
public class NoUppercaseInAttributesProcessorYamlTest extends RuleProcessorTestUtil {
    ...
    private static final String NO_UPPERCASE_IN_ATTRIBUTES_FAILURE_FILE = "no-uppercase-in-attributes-failure.yaml";
    private static final String NO_UPPERCASE_IN_ATTRIBUTES_SUCCESS_FILE = "no-uppercase-in-attributes-success.yaml";

    /**
     * Default constructor.
     */
    public NoUppercaseInAttributesProcessorYamlTest() {
    ...
    public void testValidateFailure() throws ParserConfigurationException,
        ...
        List<String> expectedErrorMessages = Arrays.asList(
                prepareTestErrorMessage(
                        ...
                        "test",
                        List.of(
                                "Property [tableName] of key [createIndex] contains uppercase characters in value: "
                                        + "[USER_METADATA]",
                                "Property [indexName] of key [createIndex] contains uppercase characters in value: "
                                        + "[IDX_user_metadata]")),
                prepareTestErrorMessage(
                        "changelog_02_2",
                        "test",
                        List.of("Property [indexName] of key [createIndex] contains uppercase characters in value: "
                                + "[user-metadata-IDX]")));
