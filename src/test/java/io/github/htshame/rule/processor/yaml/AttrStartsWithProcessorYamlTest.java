...
public class AttrStartsWithProcessorYamlTest extends RuleProcessorTestUtil {
    ...
    private static final String CHANGELOG_FAILURE_FILE = "attr-starts-with-failure.yaml";
    private static final String CHANGELOG_SUCCESS_FILE = "attr-starts-with-success.yaml";
