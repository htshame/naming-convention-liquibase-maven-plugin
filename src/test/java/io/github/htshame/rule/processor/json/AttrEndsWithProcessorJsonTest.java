...
public class AttrEndsWithProcessorJsonTest extends RuleProcessorTestUtil {
    ...
    private static final String CHANGELOG_FAILURE_FILE = "attr-ends-with-failure.json";
    private static final String CHANGELOG_SUCCESS_FILE = "attr-ends-with-success.json";
