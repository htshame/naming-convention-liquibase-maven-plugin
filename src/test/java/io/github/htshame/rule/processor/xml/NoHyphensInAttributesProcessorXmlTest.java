...
public class NoHyphensInAttributesProcessorXmlTest extends RuleProcessorTestUtil {
    ...
    private static final String CHANGELOG_FAILURE_FILE_FILE = "no-hyphens-in-attributes-failure.xml";
    private static final String CHANGELOG_SUCCESS_FILE_FILE = "no-hyphens-in-attributes-success.xml";
