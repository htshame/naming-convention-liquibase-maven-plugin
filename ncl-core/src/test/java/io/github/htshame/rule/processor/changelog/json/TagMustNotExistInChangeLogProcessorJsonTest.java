package io.github.htshame.rule.processor.changelog.json;
...
public class TagMustNotExistInChangeLogProcessorJsonTest extends ChangeLogRuleProcessorTestUtil {
     ...
     * Default constructor.
     */
    public TagMustNotExistInChangeLogProcessorJsonTest() {
    ...
    public void testValidateChangeSetFailure() throws ParserConfigurationException,
        ...
        List<String> expectedErrorMessages = Arrays.asList(
                "Object <includeAll> must not exist in change log",
                "Object <includeAll> must not exist in change log"
        );
