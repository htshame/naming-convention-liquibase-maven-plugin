...
public class NoHyphensInAttributesProcessorYamlTest extends ChangeSetRuleProcessorTestUtil {
    ...
    public void testGetType() throws ParserConfigurationException, IOException, SAXException {
        ...
        // act
        RuleTypeEnum actual = NoHyphensInAttributesProcessor.instantiate(ruleElement).getType();
    ...
    public void testValidateChangeSetFailure() throws ParserConfigurationException,
        ...
        for (ChangeSetElement changeSetElement : changeSetElements) {
            try {
                NoHyphensInAttributesProcessor.instantiate(ruleElement).validateChangeSet(
                        changeSetElement,
                        exclusionParser,
