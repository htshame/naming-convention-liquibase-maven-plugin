...
public class AttrEndsWithConditionedProcessorYamlTest extends RuleProcessorTestUtil {
    ...
    private static final String CHANGELOG_FAILURE_FILE = "attr-ends-with-conditioned-failure.yaml";
    private static final String CHANGELOG_SUCCESS_FILE = "attr-ends-with-conditioned-success.yaml";

    /**
     * Default constructor.
     */
    public AttrEndsWithConditionedProcessorYamlTest() {
