...
public class AttrNotEndsWithConditionedProcessorYamlTest extends ChangeSetRuleProcessorTestUtil {
     ...
     * Default constructor.
     */
    public AttrNotEndsWithConditionedProcessorYamlTest() {
    ...
    public void testGetName() throws ParserConfigurationException, IOException, SAXException {
        ...
        // act
        RuleEnum actual = AttrNotEndsWithConditionedProcessor.instantiate(ruleElement).getName();
    ...
    public void testGetType() throws ParserConfigurationException, IOException, SAXException {
        ...
        // act
        RuleTypeEnum actual = AttrNotEndsWithConditionedProcessor.instantiate(ruleElement).getType();
    ...
    public void testValidateChangeSetFailure() throws ParserConfigurationException,
        ...
        List<String> expectedErrorMessages = Arrays.asList(
                prepareTestErrorMessage(
                        "changelog_02_3",
                        "test",
                        List.of("Key [createIndex] with unique=\"true\" must not have [indexName] "
                                + "ending with [_unique], but found: [idx_user_metadata_external_user_id_unique]")),
                prepareTestErrorMessage(
                        "changelog_02_4",
                        "test",
                        List.of("Key [createIndex] with unique=\"true\" must not have [indexName] "
