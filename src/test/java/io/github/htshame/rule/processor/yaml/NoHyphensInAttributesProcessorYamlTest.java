...
public class NoHyphensInAttributesProcessorYamlTest extends RuleProcessorTestUtil {
    ...
    private static final String CHANGELOG_FAILURE_FILE = "no-hyphens-in-attributes-failure.yaml";
    private static final String CHANGELOG_SUCCESS_FILE = "no-hyphens-in-attributes-success.yaml";
