...
public class NoHyphensInAttributesProcessorTest extends RuleProcessorTestUtil {
    ...
    public void testValidateFailure() throws ParserConfigurationException,
        ...
        Document document = DocumentBuilderFactory.newInstance()
                .newDocumentBuilder()
                .parse(new File(BASE_FILE_PATH + NO_HYPHENS_IN_ATTRIBUTES_FAILURE_XML));
        ...
        for (int i = 0; i < changeSetList.getLength(); i++) {
            try {
                ...
                NoHyphensInAttributesProcessor.fromXml(ruleElement).validate(
                        changeSetElement,
                        exclusionParser,
    ...
    public void testValidateSuccess() throws ParserConfigurationException,
        ...
        Document document = DocumentBuilderFactory.newInstance()
                .newDocumentBuilder()
                .parse(new File(BASE_FILE_PATH + NO_HYPHENS_IN_ATTRIBUTES_SUCCESS_XML));
