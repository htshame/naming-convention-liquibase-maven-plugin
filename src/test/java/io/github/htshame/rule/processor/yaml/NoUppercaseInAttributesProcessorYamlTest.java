...
public class NoUppercaseInAttributesProcessorYamlTest extends RuleProcessorTestUtil {
    ...
    private static final String CHANGELOG_FAILURE_FILE = "no-uppercase-in-attributes-failure.yaml";
    private static final String CHANGELOG_SUCCESS_FILE = "no-uppercase-in-attributes-success.yaml";
